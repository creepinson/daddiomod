...
import me.creepinson.entities.mcreator_bullet;
...
public static mcreator_bullet mcreator_1 = new mcreator_bullet();
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
		...
		ResourceLocation sound0 = new ResourceLocation("daddiomod", "creepino.death");
		GameRegistry.register(new net.minecraft.util.SoundEvent(sound0).setRegistryName(sound0));

		ResourceLocation sound1 = new ResourceLocation("daddiomod", "creepino.hurt");
		GameRegistry.register(new net.minecraft.util.SoundEvent(sound1).setRegistryName(sound1));

		ResourceLocation sound2 = new ResourceLocation("daddiomod", "creepino.screech");
