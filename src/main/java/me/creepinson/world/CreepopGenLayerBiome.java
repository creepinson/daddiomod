...
public class CreepopGenLayerBiome extends GenLayer
{
    @SuppressWarnings("unchecked")
    private java.util.List<net.minecraftforge.common.BiomeManager.BiomeEntry>[] biomes = new java.util.ArrayList[net.minecraftforge.common.BiomeManager.BiomeType.values().length];
    private final ChunkProviderSettings settings;

    public CreepopGenLayerBiome(long p_i45560_1_, GenLayer p_i45560_3_, WorldType p_i45560_4_, String p_i45560_5_)
    {
        super(p_i45560_1_);
        ...
        int desertIdx = net.minecraftforge.common.BiomeManager.BiomeType.COOL.ordinal();
        biomes[desertIdx].clear();
        biomes[desertIdx].add(new net.minecraftforge.common.BiomeManager.BiomeEntry(MeepersPlusBiomeRegistry.creepop, 10));
