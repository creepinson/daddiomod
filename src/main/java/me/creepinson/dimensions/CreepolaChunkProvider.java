...
import me.creepinson.world.BiomeCreepop;
...
public class CreepolaChunkProvider implements IChunkGenerator
{
   ...
   private Biome[] biomesForGeneration;
    ...
    public CreepolaChunkProvider(World worldIn, long seed, boolean mapFeaturesEnabledIn)
    {
        {
